...
<ul>
Coagmento is a collaborative search system that helps you to share bookmarks, text snippets, and sources, <br>as well as write and chat with members of your group.
	...
	<hr>
		<strong>
			...
			<ul>
					...
					All of your group's activity can be viewed in the Workspace. Stats show everyone's contributions.<br>
					
					Explore by searching, filtering, or sorting.
				
			</ul>
			</span>
			<center><img src="images/workspace_demo.png" width="70%" height="auto"/></center>
<!-- The Sidebar consists of:<br/> -->
<!-- <ol> -->
<?php
    if($num_users > 1){
