...
function getMarkIntentionsPanels($userID,$selectedStartTimeSeconds,$selectedEndTimeSeconds){

}

function getIntentionsPanel($userID,$selectedStartTimeSeconds,$selectedEndTimeSeconds){
