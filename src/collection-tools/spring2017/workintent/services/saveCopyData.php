...
if (Base::getInstance()->isSessionActive())
{
	...
	$query = "INSERT INTO copy_data (userID, projectID, stageID, questionID, url, title, snippet, timestamp, date, time, `localTimestamp`, `localDate`, `localTime`, type)
	...
	$action = new Action('copy',$snippetID);
	$action->setBase($base);
